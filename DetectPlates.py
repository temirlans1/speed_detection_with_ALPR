...
def detectPlatesInScene(imgOriginalScene):
    ...
    if PlateDetection.showSteps == True: # show steps #######################################################
    ...
    if PlateDetection.showSteps == True: # show steps #######################################################
        ...
        cv2.drawContours(imgContours, contours, -1, PlateDetection.SCALAR_WHITE)
    ...
    if PlateDetection.showSteps == True: # show steps #######################################################
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            cv2.line(imgContours, tuple(p2fRectPoints[0]), tuple(p2fRectPoints[1]), PlateDetection.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[1]), tuple(p2fRectPoints[2]), PlateDetection.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[2]), tuple(p2fRectPoints[3]), PlateDetection.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[3]), tuple(p2fRectPoints[0]), PlateDetection.SCALAR_RED, 2)
...
def findPossibleCharsInScene(imgThresh):
    ...
    for i in range(0, len(contours)):                       # for each contour
        ...
        if PlateDetection.showSteps == True: # show steps ###################################################
            cv2.drawContours(imgContours, contours, i, PlateDetection.SCALAR_WHITE)
        # end if # show steps #####################################################################
